...
class CategoryItem extends StatelessWidget {
  ...
  final String title;
 final int index;
 const CategoryItem({Key? key, this.onSeeAllTap,required this.title,required this.index }) : super(key: key);
    ...
    return Container(
      ...
      child: Row(
        ...
        const  SizedBox(width: 70,),
          InkWell(
            onTap: () => onSeeAllTap!(),
            child: const Icon(Icons.arrow_forward_ios, color: Color(0xFF000000),size: 22,),
          ),
