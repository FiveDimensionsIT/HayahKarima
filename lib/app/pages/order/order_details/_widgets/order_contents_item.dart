...
class OrderContentsItem extends StatelessWidget {
  const OrderContentsItem({Key? key,required this.photo,this.price,required this.title,
      ...
      child: Row(
        children: [
          ClipRRect(
            ...
            child: Image.network(photo, fit: BoxFit.cover, width: 64.w, height: 64.h),
          ),
          SizedBox(width: 16.w,),
          Expanded(
            child:  Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Expanded(child:
                    Text( "$quantity ${AppText.quantity}",
                      style: TextStyle(
                        color: AppColors.current.text1,
                        fontSize: 18.sp,
                      ),
