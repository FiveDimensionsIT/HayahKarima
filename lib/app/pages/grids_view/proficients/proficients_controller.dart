...
class ProficientsController extends GetxController {
  ...
  List<PointerItemModel> proficientsList = <PointerItemModel>[].obs;
  ...
  void getCreatorsApi() async {
    ...
    final request = DigitalPointerRequest(roleId: 5, statusId: 2, pageNo: 1, orderBy: 'indicator desc');
    ...
    if (success) {
      if (result != null) {
        proficientsList.assignAll(result?? []);
      } else {
