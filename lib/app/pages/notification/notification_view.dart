  ...
  Widget _buildButtons(){
    return Row(
      children: [
        ...
        SizedBox(width: Get.width/16,),
        _buildContentButton(AppText.notRead, Get.width/3, AppColors.current.neutral,AppColors.current.accent),
      ],
    );
  }
    ...
    return Container(
      ...
      child: ListView.builder(
        itemCount: 5,
          ...
          return Card(
            color: index % 2 == 0 ? AppColors.current.neutral : AppColors.current.dimmedLight,
            child: Row(
              children: [
                Container(
                  width: 64,height: 64,
