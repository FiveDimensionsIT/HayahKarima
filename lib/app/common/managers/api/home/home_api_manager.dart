...
class HomeApiManager implements IHomeApiManager {
  ...
  Future<List<PointerItemModel>?> getStatisticNumber(DigitalPointerRequest params) async{
    ...
    var request = HttpRequest(method: HttpMethod.get, url: 'Countries/Search$_params', )..addJsonHeaders();
    //
  ...
  Future<List<PointerItemModel>?> getProvincesPointer(DigitalPointerRequest params) async{
    final _params = '?countryId=${params.countryId}&statusId=${params.statusId}&PageNumber=${params.pageNo}&PageSize=${params.pageSize}&OrderBy=${params.orderBy}';
    var request = HttpRequest(method: HttpMethod.get, url: 'Governorates/Search$_params', )..addJsonHeaders();
    //
    var resp = await _httpService.sendRequest(request);
    //
    if(resp != null && resp.statusCode == 200 && resp.data != null){
  ...
  Future<List<PointerItemModel>?> getCategoriesPointer(DigitalPointerRequest params) async{
    ...
    var request = HttpRequest(method: HttpMethod.get, url: 'DigitalIndexCategories/Search$_params', )..addJsonHeaders();
    //
    var resp = await _httpService.sendRequest(request);
    //
    if(resp != null && resp.statusCode == 200 && resp.data != null){
  ...
  Future<List<PointerItemModel>?> getCentersPointer(DigitalPointerRequest params) async{
    final _params = '?countryId=${params.countryId}&statusId=${params.statusId}&PageNumber=${params.pageNo}&PageSize=${params.pageSize}&OrderBy=${params.orderBy}';
    var request = HttpRequest(method: HttpMethod.get, url: 'Centers/Search$_params', )..addJsonHeaders();
    //
    var resp = await _httpService.sendRequest(request);
    //
    if(resp != null && resp.statusCode == 200 && resp.data != null){
  ...
  Future<List<PointerItemModel>?> getVillagesPointer(DigitalPointerRequest params) async{
    final _params = '?countryId=${params.countryId}&statusId=${params.statusId}&PageNumber=${params.pageNo}&PageSize=${params.pageSize}&OrderBy=${params.orderBy}';
    var request = HttpRequest(method: HttpMethod.get, url: 'Villages/Search$_params', )..addJsonHeaders();
    //
    var resp = await _httpService.sendRequest(request);
    //
    if(resp != null && resp.statusCode == 200 && resp.data != null){
